SET(IN_RD_DEF_NAME "Include/FreRDMethods.h")
SET(OUT_RD_IMPL_NAME "Include/FreRDMethodsImpl_autogen.inc")
...
FOREACH(STR ${RD_METHODS})
    SET(IS_CORRECT -1)
	STRING(FIND ${STR} "RE_API_F" IS_CORRECT)

	IF (NOT ${IS_CORRECT} EQUAL -1)
		STRING(REPLACE "RE_API_F" "" FUNC ${STR})
		...
		STRING(REGEX MATCH "Ref$" "" FF_RETURN ${F_RETURN})
		MESSAGE(${FF_RETURN})
		...
		FILE(APPEND ${OUT_RD_IMPL_NAME} "RD_FUNC_IMPL_DEFS(${F_RETURN}, ${F_NAME}, (${F_PARAMS}), (${F_PARAMS_FOR_CALL})) \n")
