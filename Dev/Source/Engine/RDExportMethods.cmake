SET(IN_RD_DEF_NAME "Include/FreRDMethodsDefs.inc")
...
FOREACH(STR ${RD_METHODS})
    SET(IS_CORRECT -1)
	STRING(FIND ${STR} "RD_FUNC_DEFS" IS_CORRECT)
	...
	IF (NOT ${IS_CORRECT} EQUAL -1)
		...
		FILE(APPEND ${OUT_RD_IMPL_NAME} "RD_FUNC_IMPL_DEFS(${F_RETURN}, ${F_NAME}, (${STR_PARAMS}), (${F_PARAMS_FOR_CALL})) \n")
